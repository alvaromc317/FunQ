...
S3 method for class 'mfqpca_object'. Given an mfqpca_object model,
...
- pve.between:
  ...
  the number of between level components in Yhat estimation. Set to NULL
  to use all components.

- pve.within:

  Percentage of explained variability (between 0 and 1) used to select
  the number of within level components in Yhat estimation. Set to NULL
  to use all components.
