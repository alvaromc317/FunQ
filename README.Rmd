...
The above plot visualizes a subset of the data generated this way. Since the main methodology in the package can deal with sparse and irregular time measurements, we will include 75% of missing observations in the data matrix. 
...
You can plot the computed loadings on a somewhat not very pretty plot, but still useful

```{r, fig.height = 4, fig.width = 5.5}
plot(results)
```

And you can also compute the quantile error between the curve reconstruction and the true data
